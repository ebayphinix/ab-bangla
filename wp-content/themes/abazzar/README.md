Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/ajkerbazzar.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/ajkerbazzar)

## About

I’m a huge fan of Underscores, Bootstrap, and Sass. Why not combine these into a solid WordPress Theme Framework?
That’s what ajkerbazzar is. 
You can use it as starter theme and build your own theme on top of it. Or you use it as parent theme and create your own child theme for ajkerbazzar.

At the moment, ajkerbazzar is in a very early stage. But if you wan’t, feel free to use it for your own WordPress theme!

# ajkerbazzar WordPress Theme Framework

Website: [http://ajkerbazzar.com](http://ajkerbazzar.com)

Child Theme Project: [https://github.com/holger1411/ajkerbazzar-child](https://github.com/holger1411/ajkerbazzar-child)

## License
ajkerbazzar is released under the terms of the GPL version 2 or (at your option) any later version.
...
- Jetpack ready.
- WooCommerce support.
- [Child Theme](https://github.com/holger1411/ajkerbazzar-child) ready.
- Translation ready.
...
Some basics about the Sass and CSS files that come with ajkerbazzar:
...
- The `/css/theme.css` file provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 1 "theme/theme_variables";  // <--------- Add your variables into this file. Also add variables to overwrite Bootstrap or ajkerbazzar variables here
                  - 2 "../src/bootstrap-sass/assets/stylesheets/bootstrap";  // <--------- All the Bootstrap stuff - Don´t edit this!
                  - 3 "ajkerbazzar/ajkerbazzar"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the ajkerbazzar folder from GitHub or from ajkerbazzar.com
- IMPORTANT: If you download it from GitHub make sure you rename the "ajkerbazzar-master.zip" file just to "ajkerbazzar.zip" or you might have problems using child themes !!
- Upload it into your WordPress installation subfolder here: `/wp-content/themes/`
- Login to your WordPress backend
- Go to Appearance → Themes
- Activate the ajkerbazzar theme
...
- Then open your terminal and browse to the location of your ajkerbazzar copy
