                ...
                <div class="row mrb20">
                                ...
                                while ($the_query->have_posts()) : $the_query->the_post();
                                    ...
                                    <div>
                                        ...
                                        <?php if (wp_get_thumbnail_url(get_the_ID())): ?>
                                            <div class="col-xs-12 col-sm-8 plnone"><img class="responsive" src="<?php echo wp_get_thumbnail_url(get_the_ID(), 'medium'); ?>" alt="<?php the_title(); ?>"/></div>
                                        <?php endif; ?>
                                        <?php echo excerpt(50) ?>
                                        <div class="rmholder">
                    ...
                    <div class="col-xs-12 col-sm-5">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="rmholder">
                                            <?php echo category_read_more($cat_spotlight); ?> 
                                        </div>
                                    </div>
                                </div>
                                <div class="row">&nbsp;</div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <div class="heading">
                                    <h3 class="panel-heading">লাইফ স্টাইল ।। ফ্যাশন-গ্লামার</h3>
                                </div>
                                <?php
                                $args = array('posts_per_page' => 2, 'post_status' => 'publish', 'category' => $cat_life_style);
                                $postslist = get_posts($args);
                                foreach ($postslist as $index => $post) :
                                    setup_postdata($post);
                                    $divclose = false;
