                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="logo">
                                <a href="<?php echo esc_url(home_url('/news/multimedia')); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="multimedia">
                                    <img class="responsive" alt="multimedia" src="<?php echo get_template_directory_uri(); ?>/images/multimedia-logo.png">
                                </a> 
                                <p class="bangla_date">
                            ...
                            <div class="headline_container">
                                ...
                                <div class="ticker_slider">
                                    <marquee truespeed="truespeed" scrolldelay="30" scrollamount="1" onmouseover="this.stop();" onmouseout="this.start();" direction="left" behavior="scroll" align="top">
                                        <?php
                                        $args = array('posts_per_page' => 7, 'order' => 'DESC', 'orderby' => 'id', 'category' => 1);
