...
if (!class_exists('AmazingAds')) {
    ...
    class AmazingAds
    {
        ...
        {
            $addnew = add_submenu_page('edit.php?post_type=amadsmananger', __('Ads Settings'), __('Ads Settings')
                    , AmazingAds::CAPABILITY, 'ads-setting', array(&$this, 'amAds_setting')
            );
        }
            ...
            ?> value="true"/>
                        ...
                        <li>
                            ...
                            <select name="amads-adot" id="amads-adot">
                                ...
                                <option value="rand" <?php if ($this->amads_option['amads-adot'] == "rand") {
                        echo 'selected="selected"';
                    } ?>>Show Ads Randomly</option>
                                <option value="DESC"  <?php if ($this->amads_option['amads-adot'] == "DESC") {
                        echo 'selected="selected"';
                    } ?>>Show By Latest Ad</option>
                                <option value="ASC"  <?php if ($this->amads_option['amads-adot'] == "ASC") {
                        echo 'selected="selected"';
                    } ?>>Show By Oldest Ad</option>
                        ...
                        <li>
                            ...
                            <select name="amads-as" id="amads-as">
                                <option value="">Select</option>
            <?php
            foreach ($this->adsizes as $key => $val) {
                        ...
                        <ul class="input-group">
                            ...
                            <li>
                                ...
                                <select name="amads-aadot" id="amads-aadot">
                                    <option value="">Select</option>
                                    <option value="rand" <?php if ($this->amads_option['amads-aadot'] == "rand") {
                            echo 'selected="selected"';
                        } ?>>Show Ads Randomly</option>
                                    <option value="DESC"  <?php if ($this->amads_option['amads-aadot'] == "DESC") {
                            echo 'selected="selected"';
                        } ?>>Show By Latest Ad</option>
                                    <option value="ASC"  <?php if ($this->amads_option['amads-aadot'] == "ASC") {
                            echo 'selected="selected"';
                        } ?>>Show By Oldest Ad</option>
        ...
        public function create_meta_box()
        {
            ...
            <div class="input-holder">
                ...
                <select name="ad_type" id="ads-type">
                    ...
                    <option value="image" <?php if ($custom_fields["ad_type"][0] == "image") {
                echo 'selected="selected"';
            } ?> >Image</option>
                    <option value="codes" <?php if ($custom_fields["ad_type"][0] == "codes") {
                echo 'selected="selected"';
            } ?>>Codes</option>                        
                </select>
            </div>
        ...
        public function update_custom_meta_fields()
        {
            ...
            if ($typenow == 'amadsmananger' && isset($_POST['ad_type'])) {
                ...
                update_post_meta($post->ID, "amads_shortcode", '[amads id="' . $post->ID . '" size="' . trim($_POST["ad_sizes"]) . '" title="' . $_POST['post_title'] . '"]');
            }
        }
        ...
        public function amads_shortcode($atts)
        {
            ...
            while (have_posts()) : the_post();
                if (post_custom('ad_type')) {
                    ...
                    if ($ad_type == "image") {
                        $amads_contnet = '<a href="' . post_custom("amads_link") . '" data-amads-id=' . $id . ' class="amadas-cl" target="_blank"/>
